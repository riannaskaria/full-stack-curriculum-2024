...
export default function App() {
  ...
  // or u can remove counter from dependency array so that it only runs on the first render
// infinite loop bc set is within use
  ...
  //needs useeffect the count is updated till rendering
